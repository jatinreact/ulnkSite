        ...
        <>
            <div className="home_background_color">
                <div className="content_padding">
                    <Grid className="Component_main_grid p-3  mt-5 mb-4">
                        <Grid item md={6} className="p-3">
                            ...
                            <div className="home_para">Personalise the journey to all of your information, sales channels, social media links and so much more. </div>
                    ...
                    <div className="data_padding_from_both">
                        <Grid className="Component_main_grid">
                            <Grid item md={3} className="p-3">
                                <img src={s1} alt="" className="suggestion_image" />
                            </Grid>
                            <Grid item md={3} className="p-3">
                                <img src={s2} alt="" className="suggestion_image" />
                            </Grid>
                            <Grid item md={3} className="p-3">
                                <img src={s3} alt="" className="suggestion_image" />
                            </Grid>
                            <Grid item md={3} className="p-3">
                                <img src={s4} alt="" className="suggestion_image" />
                            </Grid>
                        </Grid>

                        <Grid className="Component_main_grid p-3 ">
                            <Grid item md={3} className="p-3">
                                <img src={s5} alt="" className="suggestion_image" />
                            </Grid>
                            <Grid item md={3} className="p-3">
                                <img src={s6} alt="" className="suggestion_image" />
                            </Grid>
                            <Grid item md={3} className="p-3">
                                <img src={s7} alt="" className="suggestion_image" />
                            </Grid>
                            <Grid item md={3} className="p-3">
                                <img src={s8} alt="" className="suggestion_image" />
                            </Grid>
                        </Grid>

                        <Grid className="Component_main_grid p-3 ">
                            <Grid item md={3} className="p-3">
                                <img src={s9} alt="" className="suggestion_image" />
                            </Grid>
                            <Grid item md={3} className="p-3">
                                <img src={s10} alt="" className="suggestion_image" />
                            </Grid>
                            <Grid item md={3} className="p-3">
                                <img src={s11} alt="" className="suggestion_image" />
                            </Grid>
                            <Grid item md={3} className="p-3">
                                <img src={s12} alt="" className="suggestion_image" />
                            </Grid>
                        </Grid>
                    </div>
                </div>
                ...
                <div className="mt-5 p-2">
                    <div className="text-center home_content">A ULNK HUB allows companies to personalise a consumer's journey.<br /> Drive people to your important information, sales channels<br /> and social media connections.</div>
